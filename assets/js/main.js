...
(function ($) {
  ...
  let secondaryColor = rootStyles
    .getPropertyValue("--primary-t-color-2")
    .trim();
  ...
  if (document.body.classList.contains("odd")) {
    ...
    secondaryColor = rootStyles
      .getPropertyValue("--secondary-t-color-2")
      .trim();
  }
...
(function ($) {
  ...
  if ($(".filter-items").length) {
    $(".explore-area").each(function (index) {
      ...
      $(this)
        .find(".filter-btn")
        .removeClass("filter-btn")
        .addClass("filter-btn-" + count);
...
let superAppModal = document.getElementById("superAppModal");
let closeBtn = document.getElementById("close");
let closebTn = document.getElementById("btnClose");

modalActive.addEventListener("click", () => {
  superAppModal.style.display = "block";
});

closeBtn.addEventListener("click", () => {
  superAppModal.style.display = "none";
});
